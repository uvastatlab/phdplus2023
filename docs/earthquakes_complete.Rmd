...
- The magSource variable reports the network that originally authored the reported magnitude for this event. Create a cross tabulation between status and magSource. See this page for network definitions: <https://www.emsc-csem.org/Earthquake/contributors.php>
...
```{r}
hist(as.numeric(d$elapsed_time))
```
...
median(d$elapsed_time, na.rm = TRUE) %>% format()
median(d$elapsed_time, na.rm = TRUE) %>% as.numeric()
