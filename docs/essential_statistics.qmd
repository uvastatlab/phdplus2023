...
However it turns out the distribution of means calculated from most distributions is fairly symmetric. This is the _Central Limit Theorem_. This means we can be fairly confident about standard error estimates.
...
We say "95%" because the method should work 95% of the time based on how many standard errors we add/subtract to create the interval.
