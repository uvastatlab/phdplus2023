...
Below we allow finsqft to _interact_ with cooling. We define an interaction with a colon `:`. This says the association between totalvalue and finsqft depends on cooling.
...
An Analysis of Variance Table can help us assess whether or not interactions are warranted. This runs a series of hypothesis tests comparing progressively more complex models.
